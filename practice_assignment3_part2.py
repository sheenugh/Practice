...
print("User wants to buy: " + str(asking_the_total_number_of_apples_a_user_wants_to_buy) + " apples")
...
print("User wants to buy: " + str(asking_the_total_number_of_oranges_a_user_wants_to_buy) + " oranges")
